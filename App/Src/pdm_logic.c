 ...
 * @note Simplified previous baremetal implementation by using a macro provided by HAL.
 */
...
/**
 * @brief Reads current sense amplifier inputs and converts them into switch circuit currents for each channel.
 * @param pdm
 */
